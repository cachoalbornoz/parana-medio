	...
	<div class="col-xs-12 col-sm-12 col-lg-12">
		<div class="card">
			...
			<div class="card-body">
                ...
                <form action ="{{route('categoria.accion')}}" id = 'form'>
                    ...
                    <div class="row mb-4">
                        <div class="col-xs-12 col-sm-6 col-lg-6">
                            {!! Form::text('categoria', null, ['class' => 'form-control', 'required', 'autofocus'=>'true']) !!}
                        </div>
                        <div class="col-xs-12 col-sm-6 col-lg-6">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-sm" style="font-size: smaller" id="categorias">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Categoria </th>
	...
	<script>
        ...
        $(document).on("click", ".actualizar", function(event){
            ...
            $.ajax({
                ...
                url 	: "{{route('categoria.accion')}}",
                type 	: 'POST',
                data    : {accion: 'editar', id:$("#categoria").val(), categoria:$("#nombre").val()},
                success: function(){
                    table.ajax.reload();
                }
            });
