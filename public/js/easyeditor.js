(function ($, document, window) {
    ...
    function EasyEditor(element, options) {
        ...
        var defaultButtons = ['negrita', 'italic', 'link', 'h2', 'h3', 'h4', 'alignleft', 'aligncenter', 'alignright'];
    ...
    EasyEditor.prototype.negrita = function () {
        var _this = this;
        var settings = {
    ...
    EasyEditor.prototype.aligncenter = function () {
        var _this = this;
        var settings = {
            buttonIdentifier: 'alinear-centro',
            buttonHtml: 'Alinear centro',
            clickHandler: function () {
